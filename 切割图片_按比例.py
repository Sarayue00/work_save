...
def get_ext(w,h,b):
    ...
    b1.append(max(0, 2*b[0] - b[2]))
    b1.append(max(0, 2*b[1] - b[3]))
    b1.append(min(w, 2*b[2] - b[0]))
    b1.append(min(h, 2*b[3] - b[1]))
    return b1
# 原图
path_img = 'D:\\03-work\\03-data\\zhishipai_1\\src_1\\JPEGImages\\'
path_xml = 'D:\\03-work\\03-data\\zhishipai_1\\src_1\\Annotations\\'
# 切割后
out_path_img = 'D:\\03-work\\03-data\\zhishipai_1\\dst_1\\JPEGImages\\'
out_path_xml = 'D:\\03-work\\03-data\\zhishipai_1\\dst_1\\Annotations\\'
